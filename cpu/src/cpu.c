...
void recibir_config_memoria(){
	...
	log_debug(logger,"Recibida informacion de memoria tamanio pagina=%i cantidadEntradasPorTabla=%i", infoDeMemoria->tamanioPagina, infoDeMemoria->cantEntradasPorTabla);
